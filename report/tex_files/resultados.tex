...
El algoritmo de Louvain identificó \textbf{7 comunidades} con funciones biológicas diferenciadas. El análisis de enriquecimiento de Gene Ontology (GO) reveló las siguientes especializaciones funcionales:
...
Módulo centrado en la tolerancia inmunológica y regulación de linfocitos (\textit{IL10, HLA-DRB1, PDCD1, CTLA4, FCGR3B, C4A/C4B}):
